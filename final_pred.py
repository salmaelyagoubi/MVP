...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:/Users/dell/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/cnn8grps_rad1_model.h5')
        ...
        self.root.geometry("1500x900")  # Increase the size of the main window

        self.panel = tk.Label(self.root)
        self.panel.place(x=100, y=3, width=640, height=480)  # Adjust the placement and size

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=800, y=115, width=400, height=400)  # Adjust the placement and size

        self.T = tk.Label(self.root)
        self.T.place(x=100, y=500)
        ...
        self.quiz_mode = tk.Button(self.root)
        self.quiz_mode.place(x=800, y=550)
        self.quiz_mode.config(text="Switch to Quiz Mode", font=("Courier", 20), wraplength=200, command=self.switch_to_quiz_mode)


        self.speak = tk.Button(self.root)
        self.speak.place(x=1105, y=550)
        ...
        self.root.bind('<space>', self.space_press)  # Bind space key to space_press method
        ...
        try:
            ...
            if hands:
                ...
                if 'bbox' in hand:
                    ...
                    white = cv2.imread("C:/Users/dell/OneDrive/Desktop/Sign-Language-To-Text-and-Speech-Conversion-master/white.jpg")
    ...
    def switch_to_quiz_mode(self):
        ...
        self.root.destroy()
        quiz_app = quiz_mode.SignLanguageApp()
        quiz_app.run()
